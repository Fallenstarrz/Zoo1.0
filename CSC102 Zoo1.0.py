...
#                                                                                                                               #
#    1. Attributes such as animalType (string), age (number), color (string). These should be attributes all animals have.      #
#    2. A stub function called makeNoise().                                                                                     #
#    3. The __init__ function.                                                                                                  #
#    4. Build a __str__ function that will allow you to easily print each object.                                               #
#                                                                                                                               #
#   Calling print for the object will automatically call the __str__ function.                                                  #
#   You will need to create at least three subclasses (child classes) of Animal.                                                #
#       For example: you could create subclasses called Birds, Snakes, Dogs, Cats, or anything else that would create a good    #
#       group with attributes of the parent along with unique attributes. Each subclass will need an                            #
#       __init__ function that calls the parent __init__ function.                                                              #
#                                                                                                                               #
